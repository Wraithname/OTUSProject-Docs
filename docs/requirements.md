...
#### User Story по сервису расчёта статистики миграции (**`USSCMS`**)

![](diagrams/out/USSergo.svg)

#### User Story по сервису получения данных по процессу миграции объектов БД (**`USSDTODB`**)

![](diagrams/out/US.svg)

#### User Story по сервису получения данных по процессу миграции Jar (**`USSDTA`**)
